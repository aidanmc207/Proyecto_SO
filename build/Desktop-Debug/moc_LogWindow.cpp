...
QT_MOC_LITERAL(1, 10, 17), // "returnToFirstView"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 7), // "onClear"
QT_MOC_LITERAL(4, 37, 8), // "onExport"
QT_MOC_LITERAL(5, 46, 8) // "onReturn"

    },
    "LogWindow\0returnToFirstView\0\0onClear\0"
    "onExport\0onReturn"
};
...
void LogWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->returnToFirstView(); break;
        case 1: _t->onClear(); break;
        case 2: _t->onExport(); break;
        case 3: _t->onReturn(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogWindow::returnToFirstView)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LogWindow::returnToFirstView()
{
