...
void Persistence::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Persistence::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Persistence::log)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Persistence::log(const QString & _t1)
{
