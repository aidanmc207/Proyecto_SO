...
QT_MOC_LITERAL(1, 7, 4), // "line"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 1), // "s"
QT_MOC_LITERAL(4, 15, 8) // "emitLine"

    },
    "Logger\0line\0\0s\0emitLine"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->line((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->emitLine((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Logger::line)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Logger::line(const QString & _t1)
{
