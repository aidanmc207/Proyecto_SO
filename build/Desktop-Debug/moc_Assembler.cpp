...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Assembler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Assembler_t qt_meta_stringdata_Assembler = {
    {
QT_MOC_LITERAL(0, 0, 9) // "Assembler"
...
QT_INIT_METAOBJECT const QMetaObject Assembler::staticMetaObject = { {
    QMetaObject::SuperData::link<WorkStation::staticMetaObject>(),
    qt_meta_stringdata_Assembler.data,
    qt_meta_data_Assembler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Assembler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Assembler.stringdata0))
