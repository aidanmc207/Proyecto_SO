...
QT_MOC_LITERAL(1, 13, 17), // "throughputUpdated"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5) // "value"

    },
    "StatsMonitor\0throughputUpdated\0\0value"
};
...
void StatsMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->throughputUpdated((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (StatsMonitor::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StatsMonitor::throughputUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StatsMonitor::throughputUpdated(double _t1)
{
